...
def F(XY_vars, util):
    ...
    v_2 = v_1
    v_4 = v_3
    v_12 = util.tnorm_vectorized(util.tconorm_vectorized(v_8, util.negation(v_9)), util.tconorm_vectorized(util.negation(v_8), v_9))
    ...
    v_22 = util.tnorm_vectorized(util.tconorm_vectorized(v_12, v_15), util.tconorm_vectorized(util.tconorm_vectorized(v_17, v_18), util.tconorm_vectorized(util.negation(v_13), util.negation(v_14))))
    v_24 = util.tnorm_vectorized(v_22, v_23)
    v_25 = util.tnorm_vectorized(util.tconorm_vectorized(v_17, v_18), util.tconorm_vectorized(util.negation(v_13), util.negation(v_14)))
    v_26 = util.tnorm_vectorized(v_12, v_15)
    v_28 = util.tnorm_vectorized(util.negation(v_23), util.tconorm_vectorized(v_25, v_26))
    v_30 = util.tnorm_vectorized(util.negation(v_13), util.negation(v_14))
    v_33 = util.tnorm_vectorized(util.tconorm_vectorized(v_15, v_30), v_32)
    v_35 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_13), util.negation(v_14)), util.tconorm_vectorized(v_13, v_14))
    v_36 = util.tnorm_vectorized(util.negation(v_32), v_35)
    v_43 = util.tnorm_vectorized(util.tconorm_vectorized(v_39, util.negation(v_40)), util.tconorm_vectorized(util.negation(v_39), v_40))
    v_44 = util.tnorm_vectorized(util.negation(v_8), util.negation(v_9))
    v_47 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.negation(v_13), util.negation(v_14)), v_44), util.tconorm_vectorized(util.negation(v_8), util.negation(v_9)))
    ...
    v_53 = util.tnorm_vectorized(v_15, util.tconorm_vectorized(v_8, v_9))
    v_54 = util.tnorm_vectorized(v_8, v_9)
    v_56 = util.tnorm_vectorized(util.tconorm_vectorized(v_49, v_50), util.tconorm_vectorized(v_53, v_54))
    v_59 = util.tnorm_vectorized(util.tconorm_vectorized(v_48, v_56), v_58)
    v_62 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_49, v_50), util.tconorm_vectorized(v_53, v_54)), util.tconorm_vectorized(v_43, v_47))
    v_63 = util.tnorm_vectorized(util.negation(v_58), v_62)
    v_70 = util.tnorm_vectorized(util.tconorm_vectorized(v_66, util.negation(v_67)), util.tconorm_vectorized(util.negation(v_66), v_67))
    v_71 = util.tnorm_vectorized(util.negation(v_39), util.negation(v_40))
    v_74 = util.tnorm_vectorized(util.tconorm_vectorized(v_47, v_71), util.tconorm_vectorized(util.negation(v_39), util.negation(v_40)))
    ...
    v_80 = util.tnorm_vectorized(util.tconorm_vectorized(v_53, v_54), util.tconorm_vectorized(v_39, v_40))
    v_81 = util.tnorm_vectorized(v_39, v_40)
    v_83 = util.tnorm_vectorized(util.tconorm_vectorized(v_76, v_77), util.tconorm_vectorized(v_80, v_81))
    v_86 = util.tnorm_vectorized(util.tconorm_vectorized(v_75, v_83), v_85)
    v_89 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_76, v_77), util.tconorm_vectorized(v_80, v_81)), util.tconorm_vectorized(v_70, v_74))
    v_90 = util.tnorm_vectorized(util.negation(v_85), v_89)
    v_97 = util.tnorm_vectorized(util.tconorm_vectorized(v_93, util.negation(v_94)), util.tconorm_vectorized(util.negation(v_93), v_94))
    v_98 = util.tnorm_vectorized(util.negation(v_66), util.negation(v_67))
    v_101 = util.tnorm_vectorized(util.tconorm_vectorized(v_74, v_98), util.tconorm_vectorized(util.negation(v_66), util.negation(v_67)))
    ...
    v_107 = util.tnorm_vectorized(util.tconorm_vectorized(v_80, v_81), util.tconorm_vectorized(v_66, v_67))
    v_108 = util.tnorm_vectorized(v_66, v_67)
    v_110 = util.tnorm_vectorized(util.tconorm_vectorized(v_103, v_104), util.tconorm_vectorized(v_107, v_108))
    v_113 = util.tnorm_vectorized(util.tconorm_vectorized(v_102, v_110), v_112)
    v_116 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_103, v_104), util.tconorm_vectorized(v_107, v_108)), util.tconorm_vectorized(v_97, v_101))
    v_117 = util.tnorm_vectorized(util.negation(v_112), v_116)
    v_124 = util.tnorm_vectorized(util.tconorm_vectorized(v_120, util.negation(v_121)), util.tconorm_vectorized(util.negation(v_120), v_121))
    v_125 = util.tnorm_vectorized(util.negation(v_93), util.negation(v_94))
    v_128 = util.tnorm_vectorized(util.tconorm_vectorized(v_101, v_125), util.tconorm_vectorized(util.negation(v_93), util.negation(v_94)))
    ...
    v_134 = util.tnorm_vectorized(util.tconorm_vectorized(v_107, v_108), util.tconorm_vectorized(v_93, v_94))
    v_135 = util.tnorm_vectorized(v_93, v_94)
    v_137 = util.tnorm_vectorized(util.tconorm_vectorized(v_130, v_131), util.tconorm_vectorized(v_134, v_135))
    v_140 = util.tnorm_vectorized(util.tconorm_vectorized(v_129, v_137), v_139)
    v_143 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_130, v_131), util.tconorm_vectorized(v_134, v_135)), util.tconorm_vectorized(v_124, v_128))
    v_144 = util.tnorm_vectorized(util.negation(v_139), v_143)
    v_151 = util.tnorm_vectorized(util.tconorm_vectorized(v_147, util.negation(v_148)), util.tconorm_vectorized(util.negation(v_147), v_148))
    v_152 = util.tnorm_vectorized(util.negation(v_120), util.negation(v_121))
    v_155 = util.tnorm_vectorized(util.tconorm_vectorized(v_128, v_152), util.tconorm_vectorized(util.negation(v_120), util.negation(v_121)))
    ...
    v_161 = util.tnorm_vectorized(util.tconorm_vectorized(v_134, v_135), util.tconorm_vectorized(v_120, v_121))
    v_162 = util.tnorm_vectorized(v_120, v_121)
    v_164 = util.tnorm_vectorized(util.tconorm_vectorized(v_157, v_158), util.tconorm_vectorized(v_161, v_162))
    v_167 = util.tnorm_vectorized(util.tconorm_vectorized(v_156, v_164), v_166)
    v_170 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_157, v_158), util.tconorm_vectorized(v_161, v_162)), util.tconorm_vectorized(v_151, v_155))
    v_171 = util.tnorm_vectorized(util.negation(v_166), v_170)
    v_178 = util.tnorm_vectorized(util.tconorm_vectorized(v_174, util.negation(v_175)), util.tconorm_vectorized(util.negation(v_174), v_175))
    v_179 = util.tnorm_vectorized(util.negation(v_147), util.negation(v_148))
    v_182 = util.tnorm_vectorized(util.tconorm_vectorized(v_155, v_179), util.tconorm_vectorized(util.negation(v_147), util.negation(v_148)))
    ...
    v_188 = util.tnorm_vectorized(util.tconorm_vectorized(v_161, v_162), util.tconorm_vectorized(v_147, v_148))
    v_189 = util.tnorm_vectorized(v_147, v_148)
    v_191 = util.tnorm_vectorized(util.tconorm_vectorized(v_184, v_185), util.tconorm_vectorized(v_188, v_189))
    v_194 = util.tnorm_vectorized(util.tconorm_vectorized(v_183, v_191), v_193)
    v_197 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_184, v_185), util.tconorm_vectorized(v_188, v_189)), util.tconorm_vectorized(v_178, v_182))
    v_198 = util.tnorm_vectorized(util.negation(v_193), v_197)
    v_205 = util.tnorm_vectorized(util.tconorm_vectorized(v_201, util.negation(v_202)), util.tconorm_vectorized(util.negation(v_201), v_202))
    v_206 = util.tnorm_vectorized(util.negation(v_174), util.negation(v_175))
    v_209 = util.tnorm_vectorized(util.tconorm_vectorized(v_182, v_206), util.tconorm_vectorized(util.negation(v_174), util.negation(v_175)))
    ...
    v_215 = util.tnorm_vectorized(util.tconorm_vectorized(v_188, v_189), util.tconorm_vectorized(v_174, v_175))
    v_216 = util.tnorm_vectorized(v_174, v_175)
    v_218 = util.tnorm_vectorized(util.tconorm_vectorized(v_211, v_212), util.tconorm_vectorized(v_215, v_216))
    v_221 = util.tnorm_vectorized(util.tconorm_vectorized(v_210, v_218), v_220)
    v_224 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_211, v_212), util.tconorm_vectorized(v_215, v_216)), util.tconorm_vectorized(v_205, v_209))
    v_225 = util.tnorm_vectorized(util.negation(v_220), v_224)
    v_232 = util.tnorm_vectorized(util.tconorm_vectorized(v_228, util.negation(v_229)), util.tconorm_vectorized(util.negation(v_228), v_229))
    v_233 = util.tnorm_vectorized(util.negation(v_201), util.negation(v_202))
    v_236 = util.tnorm_vectorized(util.tconorm_vectorized(v_209, v_233), util.tconorm_vectorized(util.negation(v_201), util.negation(v_202)))
    ...
    v_242 = util.tnorm_vectorized(util.tconorm_vectorized(v_215, v_216), util.tconorm_vectorized(v_201, v_202))
    v_243 = util.tnorm_vectorized(v_201, v_202)
    v_245 = util.tnorm_vectorized(util.tconorm_vectorized(v_238, v_239), util.tconorm_vectorized(v_242, v_243))
    v_248 = util.tnorm_vectorized(util.tconorm_vectorized(v_237, v_245), v_247)
    v_251 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_238, v_239), util.tconorm_vectorized(v_242, v_243)), util.tconorm_vectorized(v_232, v_236))
    v_252 = util.tnorm_vectorized(util.negation(v_247), v_251)
    v_259 = util.tnorm_vectorized(util.tconorm_vectorized(v_255, util.negation(v_256)), util.tconorm_vectorized(util.negation(v_255), v_256))
    v_260 = util.tnorm_vectorized(util.negation(v_228), util.negation(v_229))
    v_263 = util.tnorm_vectorized(util.tconorm_vectorized(v_236, v_260), util.tconorm_vectorized(util.negation(v_228), util.negation(v_229)))
    ...
    v_269 = util.tnorm_vectorized(util.tconorm_vectorized(v_242, v_243), util.tconorm_vectorized(v_228, v_229))
    v_270 = util.tnorm_vectorized(v_228, v_229)
    v_272 = util.tnorm_vectorized(util.tconorm_vectorized(v_265, v_266), util.tconorm_vectorized(v_269, v_270))
    v_275 = util.tnorm_vectorized(util.tconorm_vectorized(v_264, v_272), v_274)
    v_278 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_265, v_266), util.tconorm_vectorized(v_269, v_270)), util.tconorm_vectorized(v_259, v_263))
    v_279 = util.tnorm_vectorized(util.negation(v_274), v_278)
    v_286 = util.tnorm_vectorized(util.tconorm_vectorized(v_282, util.negation(v_283)), util.tconorm_vectorized(util.negation(v_282), v_283))
    v_287 = util.tnorm_vectorized(util.negation(v_255), util.negation(v_256))
    v_290 = util.tnorm_vectorized(util.tconorm_vectorized(v_263, v_287), util.tconorm_vectorized(util.negation(v_255), util.negation(v_256)))
    ...
    v_296 = util.tnorm_vectorized(util.tconorm_vectorized(v_269, v_270), util.tconorm_vectorized(v_255, v_256))
    v_297 = util.tnorm_vectorized(v_255, v_256)
    v_299 = util.tnorm_vectorized(util.tconorm_vectorized(v_292, v_293), util.tconorm_vectorized(v_296, v_297))
    v_302 = util.tnorm_vectorized(util.tconorm_vectorized(v_291, v_299), v_301)
    v_305 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_292, v_293), util.tconorm_vectorized(v_296, v_297)), util.tconorm_vectorized(v_286, v_290))
    v_306 = util.tnorm_vectorized(util.negation(v_301), v_305)
    v_313 = util.tnorm_vectorized(util.tconorm_vectorized(v_309, util.negation(v_310)), util.tconorm_vectorized(util.negation(v_309), v_310))
    v_314 = util.tnorm_vectorized(util.negation(v_282), util.negation(v_283))
    v_317 = util.tnorm_vectorized(util.tconorm_vectorized(v_290, v_314), util.tconorm_vectorized(util.negation(v_282), util.negation(v_283)))
    ...
    v_323 = util.tnorm_vectorized(util.tconorm_vectorized(v_296, v_297), util.tconorm_vectorized(v_282, v_283))
    v_324 = util.tnorm_vectorized(v_282, v_283)
    v_326 = util.tnorm_vectorized(util.tconorm_vectorized(v_319, v_320), util.tconorm_vectorized(v_323, v_324))
    v_329 = util.tnorm_vectorized(util.tconorm_vectorized(v_318, v_326), v_328)
    v_332 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_319, v_320), util.tconorm_vectorized(v_323, v_324)), util.tconorm_vectorized(v_313, v_317))
    v_333 = util.tnorm_vectorized(util.negation(v_328), v_332)
    v_340 = util.tnorm_vectorized(util.tconorm_vectorized(v_336, util.negation(v_337)), util.tconorm_vectorized(util.negation(v_336), v_337))
    v_341 = util.tnorm_vectorized(util.negation(v_309), util.negation(v_310))
    v_344 = util.tnorm_vectorized(util.tconorm_vectorized(v_317, v_341), util.tconorm_vectorized(util.negation(v_309), util.negation(v_310)))
    ...
    v_350 = util.tnorm_vectorized(util.tconorm_vectorized(v_323, v_324), util.tconorm_vectorized(v_309, v_310))
    v_351 = util.tnorm_vectorized(v_309, v_310)
    v_353 = util.tnorm_vectorized(util.tconorm_vectorized(v_346, v_347), util.tconorm_vectorized(v_350, v_351))
    v_356 = util.tnorm_vectorized(util.tconorm_vectorized(v_345, v_353), v_355)
    v_359 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_346, v_347), util.tconorm_vectorized(v_350, v_351)), util.tconorm_vectorized(v_340, v_344))
    v_360 = util.tnorm_vectorized(util.negation(v_355), v_359)
    v_367 = util.tnorm_vectorized(util.tconorm_vectorized(v_363, util.negation(v_364)), util.tconorm_vectorized(util.negation(v_363), v_364))
    v_368 = util.tnorm_vectorized(util.negation(v_336), util.negation(v_337))
    v_371 = util.tnorm_vectorized(util.tconorm_vectorized(v_344, v_368), util.tconorm_vectorized(util.negation(v_336), util.negation(v_337)))
    ...
    v_377 = util.tnorm_vectorized(util.tconorm_vectorized(v_350, v_351), util.tconorm_vectorized(v_336, v_337))
    v_378 = util.tnorm_vectorized(v_336, v_337)
    v_380 = util.tnorm_vectorized(util.tconorm_vectorized(v_373, v_374), util.tconorm_vectorized(v_377, v_378))
    v_383 = util.tnorm_vectorized(util.tconorm_vectorized(v_372, v_380), v_382)
    v_386 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_373, v_374), util.tconorm_vectorized(v_377, v_378)), util.tconorm_vectorized(v_367, v_371))
    v_387 = util.tnorm_vectorized(util.negation(v_382), v_386)
    v_394 = util.tnorm_vectorized(util.tconorm_vectorized(v_390, util.negation(v_391)), util.tconorm_vectorized(util.negation(v_390), v_391))
    v_395 = util.tnorm_vectorized(util.negation(v_363), util.negation(v_364))
    v_398 = util.tnorm_vectorized(util.tconorm_vectorized(v_371, v_395), util.tconorm_vectorized(util.negation(v_363), util.negation(v_364)))
    ...
    v_404 = util.tnorm_vectorized(util.tconorm_vectorized(v_377, v_378), util.tconorm_vectorized(v_363, v_364))
    v_405 = util.tnorm_vectorized(v_363, v_364)
    v_407 = util.tnorm_vectorized(util.tconorm_vectorized(v_400, v_401), util.tconorm_vectorized(v_404, v_405))
    v_410 = util.tnorm_vectorized(util.tconorm_vectorized(v_399, v_407), v_409)
    v_413 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_400, v_401), util.tconorm_vectorized(v_404, v_405)), util.tconorm_vectorized(v_394, v_398))
    v_414 = util.tnorm_vectorized(util.negation(v_409), v_413)
    v_421 = util.tnorm_vectorized(util.tconorm_vectorized(v_417, util.negation(v_418)), util.tconorm_vectorized(util.negation(v_417), v_418))
    v_422 = util.tnorm_vectorized(util.negation(v_390), util.negation(v_391))
    v_425 = util.tnorm_vectorized(util.tconorm_vectorized(v_398, v_422), util.tconorm_vectorized(util.negation(v_390), util.negation(v_391)))
    ...
    v_431 = util.tnorm_vectorized(util.tconorm_vectorized(v_404, v_405), util.tconorm_vectorized(v_390, v_391))
    v_432 = util.tnorm_vectorized(v_390, v_391)
    v_434 = util.tnorm_vectorized(util.tconorm_vectorized(v_427, v_428), util.tconorm_vectorized(v_431, v_432))
    v_437 = util.tnorm_vectorized(util.tconorm_vectorized(v_426, v_434), v_436)
    v_440 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_427, v_428), util.tconorm_vectorized(v_431, v_432)), util.tconorm_vectorized(v_421, v_425))
    v_441 = util.tnorm_vectorized(util.negation(v_436), v_440)
    v_448 = util.tnorm_vectorized(util.tconorm_vectorized(v_444, util.negation(v_445)), util.tconorm_vectorized(util.negation(v_444), v_445))
    v_449 = util.tnorm_vectorized(util.negation(v_417), util.negation(v_418))
    v_452 = util.tnorm_vectorized(util.tconorm_vectorized(v_425, v_449), util.tconorm_vectorized(util.negation(v_417), util.negation(v_418)))
    ...
    v_458 = util.tnorm_vectorized(util.tconorm_vectorized(v_431, v_432), util.tconorm_vectorized(v_417, v_418))
    v_459 = util.tnorm_vectorized(v_417, v_418)
    v_461 = util.tnorm_vectorized(util.tconorm_vectorized(v_454, v_455), util.tconorm_vectorized(v_458, v_459))
    v_464 = util.tnorm_vectorized(util.tconorm_vectorized(v_453, v_461), v_463)
    v_467 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_454, v_455), util.tconorm_vectorized(v_458, v_459)), util.tconorm_vectorized(v_448, v_452))
    v_468 = util.tnorm_vectorized(util.negation(v_463), v_467)
    v_475 = util.tnorm_vectorized(util.tconorm_vectorized(v_471, util.negation(v_472)), util.tconorm_vectorized(util.negation(v_471), v_472))
    v_476 = util.tnorm_vectorized(util.negation(v_444), util.negation(v_445))
    v_479 = util.tnorm_vectorized(util.tconorm_vectorized(v_452, v_476), util.tconorm_vectorized(util.negation(v_444), util.negation(v_445)))
    ...
    v_485 = util.tnorm_vectorized(util.tconorm_vectorized(v_458, v_459), util.tconorm_vectorized(v_444, v_445))
    v_486 = util.tnorm_vectorized(v_444, v_445)
    v_488 = util.tnorm_vectorized(util.tconorm_vectorized(v_481, v_482), util.tconorm_vectorized(v_485, v_486))
    v_491 = util.tnorm_vectorized(util.tconorm_vectorized(v_480, v_488), v_490)
    v_494 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_481, v_482), util.tconorm_vectorized(v_485, v_486)), util.tconorm_vectorized(v_475, v_479))
    v_495 = util.tnorm_vectorized(util.negation(v_490), v_494)
    v_499 = util.tnorm_vectorized(util.tconorm_vectorized(v_485, v_486), util.tconorm_vectorized(v_471, v_472))
    v_500 = util.tnorm_vectorized(v_471, v_472)
    v_504 = util.tnorm_vectorized(util.negation(v_471), util.negation(v_472))
    v_507 = util.tnorm_vectorized(util.tconorm_vectorized(v_479, v_504), util.tconorm_vectorized(util.negation(v_471), util.negation(v_472)))
    v_509 = util.tnorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_499, v_500), v_502), util.tconorm_vectorized(util.negation(v_502), v_507))
    v_511 = util.tnorm_vectorized(v_509, v_510)
    v_512 = util.tnorm_vectorized(util.negation(v_502), v_507)
    v_513 = util.tnorm_vectorized(util.tconorm_vectorized(v_499, v_500), v_502)
    v_515 = util.tnorm_vectorized(util.negation(v_510), util.tconorm_vectorized(v_512, v_513))
    v_518 = util.tnorm_vectorized(util.tconorm_vectorized(v_511, v_515), v_517)
    v_521 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_510), util.tconorm_vectorized(v_512, v_513)), util.tconorm_vectorized(v_509, v_510))
    v_522 = util.tnorm_vectorized(util.negation(v_517), v_521)
    v_528 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_23), util.tconorm_vectorized(v_25, v_26)), util.tconorm_vectorized(v_22, v_23))
    v_531 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_32), v_35), util.tconorm_vectorized(util.tconorm_vectorized(v_15, v_30), v_32))
    v_532 = util.tnorm_vectorized(v_528, v_531)
    v_535 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_58), v_62), util.tconorm_vectorized(util.tconorm_vectorized(v_48, v_56), v_58))
    v_536 = util.tnorm_vectorized(v_532, v_535)
    v_539 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_85), v_89), util.tconorm_vectorized(util.tconorm_vectorized(v_75, v_83), v_85))
    v_540 = util.tnorm_vectorized(v_536, v_539)
    v_543 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_112), v_116), util.tconorm_vectorized(util.tconorm_vectorized(v_102, v_110), v_112))
    v_544 = util.tnorm_vectorized(v_540, v_543)
    v_547 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_139), v_143), util.tconorm_vectorized(util.tconorm_vectorized(v_129, v_137), v_139))
    v_548 = util.tnorm_vectorized(v_544, v_547)
    v_551 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_166), v_170), util.tconorm_vectorized(util.tconorm_vectorized(v_156, v_164), v_166))
    v_552 = util.tnorm_vectorized(v_548, v_551)
    v_555 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_193), v_197), util.tconorm_vectorized(util.tconorm_vectorized(v_183, v_191), v_193))
    v_556 = util.tnorm_vectorized(v_552, v_555)
    v_559 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_220), v_224), util.tconorm_vectorized(util.tconorm_vectorized(v_210, v_218), v_220))
    v_560 = util.tnorm_vectorized(v_556, v_559)
    v_563 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_247), v_251), util.tconorm_vectorized(util.tconorm_vectorized(v_237, v_245), v_247))
    v_564 = util.tnorm_vectorized(v_560, v_563)
    v_567 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_274), v_278), util.tconorm_vectorized(util.tconorm_vectorized(v_264, v_272), v_274))
    v_568 = util.tnorm_vectorized(v_564, v_567)
    v_571 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_301), v_305), util.tconorm_vectorized(util.tconorm_vectorized(v_291, v_299), v_301))
    v_572 = util.tnorm_vectorized(v_568, v_571)
    v_575 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_328), v_332), util.tconorm_vectorized(util.tconorm_vectorized(v_318, v_326), v_328))
    v_576 = util.tnorm_vectorized(v_572, v_575)
    v_579 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_355), v_359), util.tconorm_vectorized(util.tconorm_vectorized(v_345, v_353), v_355))
    v_580 = util.tnorm_vectorized(v_576, v_579)
    v_583 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_382), v_386), util.tconorm_vectorized(util.tconorm_vectorized(v_372, v_380), v_382))
    v_584 = util.tnorm_vectorized(v_580, v_583)
    v_587 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_409), v_413), util.tconorm_vectorized(util.tconorm_vectorized(v_399, v_407), v_409))
    v_588 = util.tnorm_vectorized(v_584, v_587)
    v_591 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_436), v_440), util.tconorm_vectorized(util.tconorm_vectorized(v_426, v_434), v_436))
    v_592 = util.tnorm_vectorized(v_588, v_591)
    v_595 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_463), v_467), util.tconorm_vectorized(util.tconorm_vectorized(v_453, v_461), v_463))
    v_596 = util.tnorm_vectorized(v_592, v_595)
    v_599 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_490), v_494), util.tconorm_vectorized(util.tconorm_vectorized(v_480, v_488), v_490))
    v_600 = util.tnorm_vectorized(v_596, v_599)
    v_603 = util.tnorm_vectorized(util.tconorm_vectorized(util.negation(v_517), v_521), util.tconorm_vectorized(util.tconorm_vectorized(v_511, v_515), v_517))
    ...
    v_615 = util.tnorm_vectorized(util.tnorm_vectorized(util.tnorm_vectorized(util.tnorm_vectorized(util.tnorm_vectorized(v_6, util.tconorm_vectorized(util.negation(v_7), util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_24, v_28), util.tconorm_vectorized(v_33, v_36)), util.tconorm_vectorized(v_59, v_63)), util.tconorm_vectorized(v_86, v_90)), util.tconorm_vectorized(v_113, v_117)), util.tconorm_vectorized(v_140, v_144)), util.tconorm_vectorized(v_167, v_171)), util.tconorm_vectorized(v_194, v_198)), util.tconorm_vectorized(v_221, v_225)), util.tconorm_vectorized(v_248, v_252)), util.tconorm_vectorized(v_275, v_279)), util.tconorm_vectorized(v_302, v_306)), util.tconorm_vectorized(v_329, v_333)), util.tconorm_vectorized(v_356, v_360)), util.tconorm_vectorized(v_383, v_387)), util.tconorm_vectorized(v_410, v_414)), util.tconorm_vectorized(v_437, v_441)), util.tconorm_vectorized(v_464, v_468)), util.tconorm_vectorized(v_491, v_495)), util.tconorm_vectorized(v_518, v_522)))), util.tconorm_vectorized(v_7, v_604)), util.tconorm_vectorized(util.negation(v_606), v_608)), util.tconorm_vectorized(v_606, util.tconorm_vectorized(util.negation(v_1), util.negation(v_607)))), v_614)
    v_617 = util.tnorm_vectorized(util.tnorm_vectorized(util.tnorm_vectorized(util.tnorm_vectorized(v_6, util.tconorm_vectorized(util.negation(v_7), util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(util.tconorm_vectorized(v_24, v_28), util.tconorm_vectorized(v_33, v_36)), util.tconorm_vectorized(v_59, v_63)), util.tconorm_vectorized(v_86, v_90)), util.tconorm_vectorized(v_113, v_117)), util.tconorm_vectorized(v_140, v_144)), util.tconorm_vectorized(v_167, v_171)), util.tconorm_vectorized(v_194, v_198)), util.tconorm_vectorized(v_221, v_225)), util.tconorm_vectorized(v_248, v_252)), util.tconorm_vectorized(v_275, v_279)), util.tconorm_vectorized(v_302, v_306)), util.tconorm_vectorized(v_329, v_333)), util.tconorm_vectorized(v_356, v_360)), util.tconorm_vectorized(v_383, v_387)), util.tconorm_vectorized(v_410, v_414)), util.tconorm_vectorized(v_437, v_441)), util.tconorm_vectorized(v_464, v_468)), util.tconorm_vectorized(v_491, v_495)), util.tconorm_vectorized(v_518, v_522)))), util.tconorm_vectorized(v_7, v_604)), util.tconorm_vectorized(util.negation(v_606), v_608)), util.tconorm_vectorized(v_606, util.tconorm_vectorized(util.negation(v_1), util.negation(v_607))))
    v_618 = v_614

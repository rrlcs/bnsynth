...
verilog_files = ['xor_2_4.v', 'misc4_2_3.v', 'xor_5_3.v', 'xor_6_10.v', 'multiplexer_1_1.v', 'xor_1_3.v', 'xor_4_2.v', 'xnor_7_1.v', 'misc2_3_1.v', 'misc1_2_1.v', 'xor_2_2.v', 'xor_8_8.v', 'xor_3_1.v', 'xor_5_1.v', 'xor_3_2.v', 'xor_2_3.v', 'xor_8_1.v', 'xor_4_1.v', 'mirror_20_20.v', 'misc5_6_1.v', 'xor_5_2.v',
                 'misc3_2_3.v', 'xor_1_2.v', 'xnor_6_2.v', 'xor_3_3.v', 'xor_6_26.v', 'xor-implies_8_8.v', 'xor_7_1.v', 'xor_6_2.v', 'mirror_10_10.v', 'multiplexer_3_3.v', 'xor_6_1.v', 'mirror_5_5.v', 'xor-implies_7_1.v', 'xor_1_4.v', 'adder_4_9.v', 'xor_4_3.v', 'multiplexer_2_2.v', 'xor-implies_1_1.v', 'xor_1_5.v', 'xnor_implies_7_1.v']
# print((verilog_files))

# exit()
data = pd.read_csv("experiments/raw_char_comparison_results.csv")

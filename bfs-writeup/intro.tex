...
% given a Boolean formula F(X, Y) specifying 
% a desired relation between inputs X and outputs Y, we wish to synthesize each output in Y 
% as a function of inputs X such that F(X, Y) is satisfied, whenever possible.
